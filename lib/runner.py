...
directory = "/kaggle/working/LaneATT/laneatt_r34_tusimple/models/model_0050.pt"
directory1 = "/kaggle/working/LaneATT/laneatt_r34_tusimple/models/"
    ...
    def train(self):
        ...
        for epoch in trange(starting_epoch, max_epochs + 1, initial=starting_epoch - 1, total=max_epochs):
            ...
            if os.path.exists(file_path):
                ...
                send_file_to_telegram(BOT_TOKEN, CHAT_ID, '/kaggle/working/LaneATT/laneatt_r34_tusimple/models/model_115.zip.part3')
